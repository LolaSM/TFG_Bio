...
grupoA_vector = zeros(43, 12);
grupoB_vector = zeros(44, 12);
...
for i = 1:43
    ...
    grupoA_vector(i, :) = [mediaAcc_A, stdAcc_A, kurAcc_A, skwAcc_A];
...
for i = 1:44
    ...
    grupoB_vector(i, :) = [mediaAcc_B, stdAcc_B, kurAcc_B, skwAcc_B];
end
...
varNames = {'mediaAccX','mediaAccY','mediaAccZ', ...
...
writetable(tabla_completa_vectores, 'tablaVectores_AB_acceleration.csv');