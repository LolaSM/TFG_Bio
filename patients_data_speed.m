...
for i = 1:43
    ...
    grupoA_vector(i, :) = [mediaVel_A, stdVel_A, kurVel_A, skwVel_A];
...
for i = 1:44
    ...
    grupoB_vector(i, :) = [mediaVel_B, stdVel_B, kurVel_B, skwVel_B];
end
...
writetable(tabla_completa_vectores, 'tablaVectores_AB_speed.csv');